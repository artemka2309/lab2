...
makeSelect.addEventListener('change', () => {
  ...
  if (makeSelect.value !== '') {
    ...
    // Устанавливаем значение класса автомобиля
    carClassSelect.value = makeSelect.value.toLowerCase();
  } else {
...
// Разблокируем кнопку "Найти автомобиль", если все обязательные поля заполнены
